...
def analyzeGenomicRegionWave(alignment_file,region,region_name,out_dir,reported,wave):
    ...
    print("before removing for wave ...")
    print(df.shape)
    ...
    dfwave = pd.read_csv("/net/fs01.cluster.com/home/tmhsxs240/COVID_19/reference/4_Curated_MCOV_MRN_Strains_good_5085_"+wave+".csv")
    ...
    dfjoin.sort_values(by=['POS'],inplace=True)
    dfjoin.to_excel(out_dir+"COVID_SNP_MAP_"+region_name+"_NTA_"+wave+".xlsx",index=False)
